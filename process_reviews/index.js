...
function createRoundOnePrompt(reviews) {
	...
	const reviewContent = reviews.join("\n\n")
...
async function processReviewBatch(i, intermediaryFolder, finalFolder) {
...
async function processReviews() {
	...
	for (let i = 0; i < reviews.length; i += batchSize) {
		await processReviewBatch(i, intermediaryFolder, finalFolder);
	}
}
